...
def dinheiro():
        ...
        nameUser = ctk.CTkLabel(master=money,
                                width=260,height=29,
                                text='Olá Rodriggo',font=('Poppins',40,'normal'),
                                text_color=Purple,
...
def transações():
     ...
     mytransations = ctk.CTkLabel(master=transações,
                                  text='R$ 700,80',text_color=Purple,
...
def Dashboard():
    ...
    ButtonEconomy = ctk.CTkButton(master=Mydashboard,image=Economyimage,
                                  ...
                                  fg_color=White,bg_color=White,command=transações,
                                  hover=White)
